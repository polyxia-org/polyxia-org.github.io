...
**Polyxia** is a voice assistant project created by **DevOps students at Polytech Montpellier** that includes a FaaS architecture base on [Morty](https://morty-faas.github.io/).
